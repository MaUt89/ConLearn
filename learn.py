...
def learn(settings):
    ...
    for i in range(models_to_learn):
        id = ConLearn.model_id_get(settings["MODEL_LIBRARY_FILE_PATH"], i + 4)
...
settings_dict = {
    "TRAINING_FILE_PATH": "Learning Data Input/V2_XML/TrainingData_725_RuleFeatures.csv",
    ...
    "INPUT_XML": "Learning Data Input/V2_XML/XML Input/Request_4.xml",
